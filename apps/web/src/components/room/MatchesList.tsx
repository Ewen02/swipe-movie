          ...
          <div className="flex justify-center">
            <FortuneWheel
              ...
              onSpinEnd={(item) => {
                ...
                if (match?.movie) {
                  // The wheel's own result screen IS the shared "decision" moment
                  // ("on regarde X ce soir"); don't open the details modal over
                  // it. Just record that the group actually decided.
                  captureEvent('final_decision_made', {
                    roomId,
                    movieId: String(match.movie.id),
